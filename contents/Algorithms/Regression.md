...
name: image2
---
[üì-Source](https://www.shutterstock.com/image-illustration/annotated-diagram-explaining-components-graph-showing-1406041139) 
```
...
[üì-Explanation](https://towardsdatascience.com/log-book-practical-guide-to-linear-polynomial-regression-in-r-e0ed2e7f8031)
...
- **Penalized Regression** or **Regularization**:
	...
	[üì-Explanation](https://www.analyticsvidhya.com/blog/2016/01/ridge-lasso-regression-python-complete-tutorial/)
...
width: 70%
---
LASSO vs Ridge, the red contours are that of RSS whereas the geometric shapes are that of Ridge and Lasso. [(üì-Source)](https://towardsdatascience.com/ridge-and-lasso-regression-a-complete-guide-with-python-scikit-learn-e20e34bcbf0b) 
```
...
[üì-Explanation](https://www.analyticsvidhya.com/blog/2018/03/introduction-regression-splines-python-codes/)
...
```{admonition} Solution:
:class: dropdown
[üì-Source](https://www.nicksingh.com/posts/30-machine-learning-interview-questions-ml-interview-study-guide)
...
```{admonition} Solution:
:class: dropdown
[üì-Source](https://cppcodingzen.com/?p=1609)
